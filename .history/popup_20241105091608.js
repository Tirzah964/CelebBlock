...
function updateBlockListUI(blockList) {
  ...
  blockList.forEach((item, index) => {
    ...
    deleteButton.style.padding = "2px 5px"; // Adjust padding for a smaller button
    deleteButton.style.fontSize = "0.8em"; // Make font smaller
    deleteButton.style.cursor = "pointer"; // Optional: Change cursor to pointer
